...
import com.design.material.materialdesign.materialdemo.app.ToolbarManager;
import com.design.material.materialdesign.materialdemo.drawable.ThemeDrawable;
import com.design.material.materialdesign.materialdemo.util.ThemeUtil;
import com.design.material.materialdesign.materialdemo.util.ViewUtil;
import com.design.material.materialdesign.materialdemo.widget.SnackBar;
import com.design.material.materialdesign.materialdemo.widget.TabIndicatorView;

import java.lang.reflect.Field;
import java.util.ArrayList;

public class MaterialDemoActivity extends AppCompatActivity implements ToolbarManager.OnToolbarGroupChangedListener {
...
//                Toast.makeText(this, "Current theme: " + theme, Toast.LENGTH_SHORT).show();
	...
	class DrawerAdapter extends BaseAdapter implements View.OnClickListener, ThemeManager.OnThemeChangedListener {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View v = convertView;
			if(v == null) {
                v = LayoutInflater.from(MaterialDemoActivity.this).inflate(R.layout.row_drawer, null);
